...
> **Рабочая среда после T-02 — только Windows.** Кодирование, запуск Godot,
> тесты, ручная проверка и экспорт выполняются из этой Windows-копии проекта:
> `D:\Code AI\Games\Godot v1`. VPS больше не используется для продолжения
> разработки.
