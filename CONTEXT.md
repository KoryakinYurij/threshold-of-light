...
- Engine: Godot 4.7.1 stable (pinned; see ADR-001)
...
- **Unstable Loot** — high-value expedition resource, lost on death only; banked (100%) on successful extraction. See ADR-002.
...
Godot 4.7.1 stable (patch version pinned; see ADR-001).
...
- Phase 1 readiness audit: `docs/research/phase-1-readiness-audit.md` (2026-07-31) — resolved contradictions, deferred spec gaps.
- Saves (SaveManager + RunState/ProfileState) are in scope of Phase 1 — see audit, item 2.
