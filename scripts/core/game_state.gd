...
##
## Не God object: три состояния живут отдельными объектами и ничего не знают
## друг о друге. GameState их только держит и обнуляет.
##
...
## Передайте сид явно для воспроизводимого забега, иначе будет выдан новый.
